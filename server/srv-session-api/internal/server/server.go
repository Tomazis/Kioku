...
func (s *gRPCServer) Start(ctx context.Context, cfg *config.Config, sessionAPI *pb.SrvSessionApiServer) error {
	...
	pb.RegisterSrvSessionApiServer(grpcServer, *sessionAPI)
